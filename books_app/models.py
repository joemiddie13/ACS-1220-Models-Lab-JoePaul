...
class User(db.Model):
    ...
    favorite_books = db.relationship('Book', secondary='favorite_book_table', back_populates='users')
...
# Define the association table for the many-to-many relationship between Book and User
...
class Book(db.Model):
    ...
    users = db.relationship('User', secondary='favorite_book_table', back_populates='favorite_books')
